...
__$styleInject(".root{margin:0}canvas{background:#000}#left,#right{float:left}#right{margin-left:30;width:15rem}#score{font-size:1rem}#hackbit-vote-widget{clear:both}", undefined);
...
function start() {
  ...
  var red = 2 - (bb1.hp > 0 ? 0 : 1) - (bb2.hp > 0 ? 0 : 1);
